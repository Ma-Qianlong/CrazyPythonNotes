...
# -*- *************** -*-
# @File  : DownUtil.py
# @Description : 多线程下载的工具类
# @Author: mql
# @Time  : 2020-10-10 13:40
# -*- *************** -*-
...
# 定义了 DownThread 线程类，该线程类负责读取从 start_pos 开始、长度为 current_part_size 的所有字节数据，
# 并写入本地文件对象中 。 DownThread 线程类的 run（）方法就是一个简单的输入／输出实现。
