...
def loadCfgInfo():
    ...
    logger.info("post_his_url= %s" % post_his_url)
    logger.info("ip_tagPrefix: %s" % str(ip_tagPrefix))
    return (collect_frequency, post_rt_url, post_his_url)
...
def post2redis():
    ...
    logger.debug("post2redis[" + post_rt_url + "]: " + json.dumps(tagnameValue) + ", r=" + str(r))
...
def post2his(datatime):
    ...
    logger.debug("post2his[" + post_his_url + "]: " + json.dumps(dArr) + ", r=" + str(r))
...
if __name__ == "__main__":
    ...
    collect_frequency = cfgInfo[0]
    post_rt_url = cfgInfo[1]
    post_his_url = cfgInfo[2]
    logger.info("start with config [collect_frequency= %d, post_rt_url= %s,post_his_url= %s]" % (collect_frequency, post_rt_url, post_his_url))
