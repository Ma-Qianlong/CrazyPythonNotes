...
def my_test():
    try:
        ...
        demo1 = master.execute(1, cst.READ_INPUT_REGISTERS, 30000, 46)
        print(demo1)
        demo1 = master.execute(1, cst.READ_INPUT_REGISTERS, 30000, 46, data_format=">" + (46 * "h"))
        print(demo1)

        # demo1 = master.execute(1, cst.READ_INPUT_REGISTERS, 30000, 46, data_format=">" + (92*"B"))
        # print(demo1)
        # print(demo1[25])
        # print(type(demo1[25]))
        # print((demo1[25]))
        ...
        # demo1 = master.execute(1, cst.READ_INPUT_REGISTERS, 30027, 2, data_format=">" + (2 * "h"))
        # print(demo1)

        print(bin(demo1[27]))
        print(bin(demo1[28]))

        print(int("0b1110100", 2))
        print(int("0b1111001100001", 2))
        print(int("0b01100001", 2))
        print(int("0b11110", 2) << 8)
